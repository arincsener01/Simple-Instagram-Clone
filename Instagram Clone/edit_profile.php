							  ...
							  <div class="modal-dialog">
							    ...
							    <div class="modal-content">
							      <div class="modal-header">
							        ...
							        <h4 class="modal-title">Password Recovery Question</h4>
							      </div>
							      <div class="modal-body">
							        <form action="recovery.php?id=<?php echo $user_id;?>" method="post" id="f">
									<strong>Answer one of these questions...</strong><br><br>
                                    <strong>What was your mother's last name before marriage?</strong><br>
                                    <strong>OR</strong><br>
                                    <strong>What is your year of graduation from CTIS?</strong><br>
									<textarea class="form-control" cols="83" rows="4" name="content" placeholder="Type your answer here..."></textarea><br/>
									<input class="btn btn-default" type="submit" name="sub" value="Submit" style="width:100px;" /><br><br>
									<pre >You need to answer the question above in case you forgot your <br>PASSWORD.
									</pre>
									<br><br>
									</form>
									<?php
